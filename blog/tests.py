...
class TestView(TestCase):
    ...
    def test_post_list(self):
        ...
        self.assertIn(self.post_001.author.username.upper(), post_001_card.text) # 갑툭튀 나중에 안되면 이거 지우셈
        ...
        self.assertIn(self.post_002.author.username.upper(), post_002_card.text)  # 갑툭튀 나중에 안되면 이거 지우셈
        ...
        self.assertIn(self.post_003.author.username.upper(), post_003_card.text)  # 갑툭튀 나중에 안되면 이거 지우셈
    ...
    def test_create_post(self):
        # 로그인하지 않으면 status code가 200이 되도록 하면 안됨(status code != 200 -->404 Not Found)
    ...
    def test_search(self):
        post_about_python = Post.objects.create(
            ...
            content='Hello Wolrd. We are the world.',
            author=self.user_trump
        )
